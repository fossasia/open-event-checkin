...
<template>
  <div class="mx-auto flex flex-col xl:flex-row items-center gap-16 w-3/4 h-full py-16">
    <!--
    <div
    class="mx-auto items-center py-16 lg:h-full w-3/4 flex flex-col xl:flex-row gap-16 xl:gap-x-8 overflow-hidden"
  >
  -->
